...
features by a gating signal from the decoder, suppressing background activations. That suits
stroke lesions well, since they occupy a tiny fraction of the brain volume and naive skip
connections propagate background texture that inflates false positives.
...
|---|---|---|---|---|---|
| Baseline (Attention U-Net, ISLES'22 only) | 0.726 ± 0.004 | 0.726 ± 0.004 | n/a | n/a | n/a |
